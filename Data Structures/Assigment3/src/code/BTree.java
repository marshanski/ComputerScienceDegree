...
public class BTree<T extends Comparable<T>> {
    ...
    public void insert(T value) {
        ...
        else 
        {
            ...
            if(wasSplited)
            {
                splitedKeys.push(value);
                backtrackStack.push(splitedKeys);
                backtrackStack.push(SPLIT);
                
            }    
            else
            {
                backtrackStack.push(value);
                backtrackStack.push(INSERT);
            }
        }
     ...
     */
    private T split(Node<T> node,Deque splitedKeys) 
    {
    ...
    protected static class Node<T extends Comparable<T>> 
    {
        ...
        public int indexOf(T value) //index of the keys
        {
            int index = -1;
        ...
        public int indexOf(Node<T> child)//index of the chiodren
        {
